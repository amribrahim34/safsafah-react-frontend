export const COPY = {
  en: {
    ...
    sections: {
      ...
      journal: "Glow Journal",
      signup: { title: "Get 10% off your first order", sub: "Routine tips, early drops and insider offers.", placeholder: "Enter your email", cta: "Subscribe" }
    },
    footer: {
  ...
  ar: {
    promo: "خصم 10% على أول طلب — استخدم الكود GLOW10",
    ...
    sections: {
      ...
      trending: "الأكثر مبيعًا",
      journal: "مجلّة اللمعان",
      signup: { title: "خصم 10% على أول طلب", sub: "نصائح روتين وإطلاقات مبكرة وعروض داخلية.", placeholder: "ادخل بريدك الإلكتروني", cta: "اشترك" }
    },
    footer: { about: "نختار عناية قائمة على العلم لبيئة مصر مع توصيل سريع ونصيحة صادقة.", rights: "جميع الحقوق محفوظة." }
  }
};

...
import type { BrandConfig, RecentlyViewedTranslations } from './_types';

interface RecentlyViewedStripProps {
  brand: BrandConfig;
  lang: 'ar' | 'en';
  t: RecentlyViewedTranslations;
}
...
export default function RecentlyViewedStrip({ lang, t }: RecentlyViewedStripProps) {
  const isRTL = lang === 'ar';
